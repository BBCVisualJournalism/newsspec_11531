define("clickableguide/bootstrap-2", ["jquery-1", "istats-1", "clickableguide/pubsub"], function(e, s) {
    var t = function() {
...
}), define("clickableguide/minihash-2", [], function() {
    var e = function() {
...
}), define("clickableguide/carousel-2", ["clickableguide/bootstrap-2"], function(e) {
    var s = function(s, t, i, n) {
        ...
        e.pubsub.on(this.pubsubNamespace + ":prev", function() {
            ...
            a.next()
        }), e.pubsub.on("ns-panel-edgware:show", function(e) {
            a.fadeInNav(e)
    ...
    return s.prototype = {
        ...
        insideVisibleSection: function() {
            return !!this.elm.find(".ns-carousel-edgware__nav").closest(".ns-panel-edgware__section--show").length
        },
        show: function(s) {
        ...
        addNav: function() {
            this.elm.append('<div class="ns-carousel-edgware__nav"><a href="#" class="ns-carousel-edgware__next-prev ns-carousel-edgware__prev" ><span class="ns-panel-edgware__hide">' + this.vocab.prevImage + '</span><span class="ns-carousel-edgware__arrow-left "></span><span class="ns-carousel-edgware__arrow-left--inside"></span></a><a href="#" class="ns-carousel-edgware__next-prev ns-carousel-edgware__next" ><span class="ns-panel-edgware__hide">' + this.vocab.nextImage + '</span><span class="ns-carousel-edgware__arrow-right"></span><span class="ns-carousel-edgware__arrow-right--inside"></span></a></div>')
        },
...
}), define("clickableguide/imager-2", ["clickableguide/bootstrap-2"], function(e) {
    var s = function(e) {
...
}), define("js/clickableguide/main-2", ["clickableguide/bootstrap-2", "clickableguide/minihash-2", "clickableguide/carousel-2", "clickableguide/imager-2"], function(e, s, t, i) {
    ...
    return n.prototype = {
        initPanels: function() {
            this.panels = new s, this.empPanels = new s, this.buildMiniHash(this.elm.find(".ns-panel-edgware__section--int"), this.panels), this.buildMiniHash(this.elm.find(".ns-panel-edgware__section--emp"), this.empPanels), this.currentPanel = this.panels.sortKeys()[0], this.poster = ""
        },
        ...
        listenForClicks: function() {
            var s = this;
            e.$(".ns-panel-edgware__hotspot ").click(function(e) {
                return s.preventDefaults(e, function() {
                    s.launchPanel(e, s)
                })
            }), e.$(".ns-panel-edgware__video__cta").on("mousedown", function(e) {
                return s.preventDefaults(e, function() {
                    s.launchPanel(e, s), s.isVideoInViewport(e.currentTarget) || e.currentTarget.scrollIntoView(!1)
                })
            }), e.$(".ns-panel-edgware__prev").click(function(e) {
                return s.preventDefaults(e, function() {
                    s.prev()
                })
            }), e.$(".ns-panel-edgware__next").click(function(e) {
                return s.preventDefaults(e, function() {
                    s.next()
                })
            }), e.$(".ns-panel-edgware__section-close").click(function(t) {
                return s.preventDefaults(t, function() {
                    e.pubsub.emit("ns-panel-edgware:hide")
                })
        ...
        launchPanel: function(s, t) {
            ...
            e.pubsub.emit("ns-panel-edgware:show", [i])
        },
        ...
        getOffsetValue: function(s) {
            return e.$(this.panels.get(s)).find(".ns-panel-edgware__section-header").outerHeight(!0) || 0 + e.$(this.panels.get(s)).find(".ns-panel-edgware__section-sub-header").outerHeight(!0) || 0
        },
        getContextSize: function() {
            return this.elm.find(".ns-panel-edgware__hotspots>img").outerHeight(!0) + this.elm.find(".ns-panel-edgware__clickable").outerHeight(!0)
        },
        ...
        loadEmp: function(s, t) {
            var i = this,
                n = t.find(".ns-panel-edgware__section-emp-data"),
                a = n.attr("data-playlist"),
                o = (new Date).getTime();
            this.poster = t.find(".ns-panel-edgware__section-emp-img"), this.empVisible || (this.empVisible = !0, i.elm.append('<div id="ns-player--' + o + '" class="ns-panel-edgware__emp_player"></div>'), i.emp = {
                elm: e.$("#ns-player--" + o),
            ...
            }), this.poster.addClass("ns-panel-edgware__section-emp-img--hide"), i.emp.player.poster(this.poster.attr("src")), i.sizeEmp(), i.emp.player.load(a), n.after(i.emp.elm)
        },
        sizeEmp: function() {
        ...
        hideEmp: function() {
            e.$(".ns-panel-edgware__section-emp-img").removeClass("ns-panel-edgware__section-emp-img--hide"), this.empVisible && (this.elm.find(".ns-panel-edgware__emp_player").remove(), this.empVisible = !1)
        },
        show: function(s) {
            this.hide(), this.currentPanel = s;
            var t = e.$(this.panels.get(s));
            t.addClass("ns-panel-edgware__section--show"), this.setHotspotActiveState(s), this.maskElm && (this.showMask(), this.maskElm.height(e.$("#blq-container-outer, #blq-container")[0].clientHeight)), this.empPanels.get(s) !== !1 ? this.loadBump(t) : this.hideEmp()
        },
        hide: function() {
            this.hideEmp(), this.elm.find(".ns-panel-edgware__section--show").removeClass("ns-panel-edgware__section--show"), this.currentPanel = this.panels.sortKeys()[0], this.hideMask(), this.setHotspotActiveState(0)
        },
        next: function() {
            var s, t = this.panels.sortKeys();
            t.indexOf(this.currentPanel) === t.length - 1 ? s = this.currentPanel : (s = t[t.indexOf(this.currentPanel) + 1], e.pubsub.emit("ns-panel-edgware:show", [s]))
        },
        prev: function() {
            var s = this.panels.sortKeys();
            if (s.indexOf(this.currentPanel) > 0) {
                var t = s[s.indexOf(this.currentPanel) - 1];
                e.pubsub.emit("ns-panel-edgware:show", [t])
            }
        },
        addNextPrevButtons: function() {
            for (var s = this, t = s.panels.sortKeys(), i = 0; i < s.panels.size; i++) {
                var n = t[i],
                    a = '<a href="#ns-panel-edgware__section-' + t[i - 1] + '" class="ns-panel-edgware__next-prev ns-panel-edgware__prev">',
                    o = '<a href="#ns-panel-edgware__section-' + t[i + 1] + '" class="ns-panel-edgware__next-prev ns-panel-edgware__next">';
                0 === i ? a = '<a href="#" class="ns-panel-edgware__next-prev ns-panel-edgware__prev ns-panel-edgware__next-prev--disabled">' : i === s.panels.size - 1 && (o = '<a href="#" class="ns-panel-edgware__next-prev ns-panel-edgware__next ns-panel-edgware__next-prev--disabled">'), e.$(s.panels.get(n)).append('<div class="ns-panel-edgware__section-nav">' + a + '<span class="ns-panel-edgware__hide">' + s.vocab.prev + '</span><span class="ns-panel-edgware__arrow-left "></span><span class="ns-panel-edgware__arrow-left--inside"></span></a><div class="ns-panel-edgware__counter"> ' + (i + 1) + " " + s.vocab.pagingDivider + " " + s.panels.size + " </div>" + o + '<span class="ns-panel-edgware__hide">' + s.vocab.next + '</span><span class="ns-panel-edgware__arrow-right"></span><span class="ns-panel-edgware__arrow-right--inside"></span></a></div>')
            }
        },
        showHideClickableGuide: function(e, s) {
            this.viewportIsBigEnoughForClickableGuide(e, s) ? (this.elm.addClass("ns-panel-edgware--interactive"), 0 !== this.currentPanel && this.showMask()) : (this.elm.removeClass("ns-panel-edgware--interactive"), this.hideMask()), this.sizeEmp()
        },
        ...
        addMask: function(s) {
            ("white" === s || "black" === s) && (e.$("body").append('<div class="ns-panel-edgware__mask ns-panel-edgware__mask--' + s + '"></div>'), this.maskElm = e.$(".ns-panel-edgware__mask"))
        },
        showMask: function() {
            this.maskElm && (this.maskElm.addClass("ns-panel-edgware__mask--show"), this.maskElm.height(e.$("body").height()))
        },
        hideMask: function() {
            this.maskElm && this.maskElm.removeClass("ns-panel-edgware__mask--show")
        },
        ...
        choosePanelPosition: function(s) {
            ...
            if ("default" === s || "centre_of_interactive" === s)
                ...
                for (t in n.panels._map) i = n.panels.get(t), i.addClass("ns-panel-edgware__section--align-right");
            else if ("centre_of_screen" === s && e.browserNotOnThePositionFixedNaughtyList)
                for (t in n.panels._map) i = n.panels.get(t), i.addClass("ns-panel-edgware__section--centre_of_screen"), i.css({
        ...
        setHotspotActiveState: function(s) {
            e.$(".ns-panel-edgware__hotspot").removeClass("ns-panel-edgware__hotspot--active"), e.$(".ns-panel-edgware__hotspot--" + s).addClass("ns-panel-edgware__hotspot--active")
        },
