define("clickableguide/bootstrap", ["jquery-1", "istats-1", "clickableguide/pubsub"], function(e, s, pubsub) {
    var t = function() {
...
}), define("clickableguide/minihash", [], function() {
    var e = function() {
...
}), define("clickableguide/carousel", ["clickableguide/bootstrap"], function(e) {
    var s = function(s, t, i, n) {
        this.elm = e.$(s), this.vocab = t, this.pubsubNamespace = "ns-carousel--" + i, this.items = this.elm.find(".ns-carousel__item"), this.currentItem = 0, this.ctaOffset = n - 32, this.addNav();
        var a = this;
        e.pubsub.on(this.pubsubNamespace + ":prev", function() {
            a.prev()
        }), e.pubsub.on(this.pubsubNamespace + ":next", function() {
            a.next()
        }), e.pubsub.on("ns-panel:show", function(e) {
            //console.log('Fired 2');
            a.fadeInNav(e)
            ...
            a.navDelegation(s), e.pubsub.emit("ns-clickable_guide:carousel:navigated")
    ...
    return s.prototype = {
        fadeInNav: function(e) {
            (e || this.insideVisibleSection()) && this.elm.find(".ns-carousel__nav").addClass("ns-carousel__nav--faded-in")
        },
        fadeOutNav: function() {
            this.elm.find(".ns-carousel__nav").removeClass("ns-carousel__nav--faded-in")
        },
        insideVisibleSection: function() {
            return !!this.elm.find(".ns-carousel__nav").closest(".ns-panel__section--show").length
        },
        show: function(s) {
            this.currentItem = s, this.items.removeClass("ns-carousel__item--show"), e.$(this.items[s]).addClass("ns-carousel__item--show")
        },
        next: function() {
        ...
        addNav: function() {
            this.elm.append('<div class="ns-carousel__nav"><a href="#" class="ns-carousel__next-prev ns-carousel__prev" ><span class="ns-panel__hide">' + this.vocab.prevImage + '</span><span class="ns-carousel__arrow-left "></span><span class="ns-carousel__arrow-left--inside"></span></a><a href="#" class="ns-carousel__next-prev ns-carousel__next" ><span class="ns-panel__hide">' + this.vocab.nextImage + '</span><span class="ns-carousel__arrow-right"></span><span class="ns-carousel__arrow-right--inside"></span></a></div>')
        },
        navDelegation: function(s) {
            var t = e.$(s.target).closest(".ns-carousel__next-prev");
            return t.length > 0 && (t.hasClass("ns-carousel__prev") && e.pubsub.emit(this.pubsubNamespace + ":prev"), t.hasClass("ns-carousel__next") && e.pubsub.emit(this.pubsubNamespace + ":next")), s.preventDefault(), s.stopPropagation(), !1
        }
    }, s
}), define("clickableguide/imager", ["clickableguide/bootstrap"], function(e) {
    var s = function(e) {
    ...
    return s.prototype = {
        change_divs_to_imgs: function() {
            var s = this;
            e.$(".idt-delayed-image-load").each(function(t, i) {
                var n = e.$(i);
...
}), define("js/clickableguide/main", ["clickableguide/bootstrap", "clickableguide/minihash", "clickableguide/carousel", "clickableguide/imager"], function(e, s, t, i) {
    ...
    return n.prototype = {
        initPanels: function() {
            this.panels = new s, this.empPanels = new s, this.buildMiniHash(this.elm.find(".ns-panel__section--int"), this.panels), this.buildMiniHash(this.elm.find(".ns-panel__section--emp"), this.empPanels), this.currentPanel = this.panels.sortKeys()[0], this.poster = ""
        },
        initCarousels: function() {
            var e = this;
            this.elm.find(".ns-carousel").each(function(s) {
                {
                    var i = this;
        ...
        callImager: function(s) {
            var t = {
                ...
                onImagesReplaced: function() {
                    ...
                    e.pubsub.emit("ns-clickable_guide:imager:updated", [t])
                }
            };
        ...
        listenForPubsubEvents: function() {
            var s = this;
            //console.log('Registering pubsub');
            e.pubsub.on("ns-panel:show", function(t) {
                //console.log('Pubsub fired');
                // window.alert('pubsub ns-panel:show, ' + t);
                s.hide(), s.choosePanelPosition(s.opts.panelsPosition), s.show(t), e.istats.log("open-panel", "newsindep-interaction", {
                    view: t
                })
            }), e.pubsub.on("ns-panel:hide", function() {
                s.hide()
            }), e.pubsub.on("ns-clickable_guide:imager:updated", function(e) {
                s.choosePanelPosition(e)
            }), e.pubsub.on("ns-clickable_guide:carousel:navigated", function() {})

            e.pubsub.emit("ns-panel:show");
        },
        listenForClicks: function() {
            var s = this;
            e.$(".ns-panel__hotspot ").click(function(e) {
                return s.preventDefaults(e, function() {
                    s.launchPanel(e, s)
                })
            }), e.$(".ns-panel__video__cta").on("mousedown", function(e) {
                return s.preventDefaults(e, function() {
                    s.launchPanel(e, s), s.isVideoInViewport(e.currentTarget) || e.currentTarget.scrollIntoView(!1)
                })
            }), e.$(".ns-panel__prev").click(function(e) {
                return s.preventDefaults(e, function() {
                    s.prev()
                })
            }), e.$(".ns-panel__next").click(function(e) {
                return s.preventDefaults(e, function() {
                    s.next()
                })
            }), e.$(".ns-panel__section-close").click(function(t) {
                return s.preventDefaults(t, function() {
                    e.pubsub.emit("ns-panel:hide")
                })
        ...
        launchPanel: function(s, t) {
            ...
            // window.alert('hotspot clicked: ' + i);
            //console.log('Launching panel');
            e.pubsub.emit("ns-panel:show", [i]);
        },
        ...
        getOffsetValue: function(s) {
            return e.$(this.panels.get(s)).find(".ns-panel__section-header").outerHeight(!0) || 0 + e.$(this.panels.get(s)).find(".ns-panel__section-sub-header").outerHeight(!0) || 0
        },
        getContextSize: function() {
            return this.elm.find(".ns-panel__hotspots>img").outerHeight(!0) + this.elm.find(".ns-panel__clickable").outerHeight(!0)
        },
        ...
        loadEmp: function(s, t) {
            var i = this,
                n = t.find(".ns-panel__section-emp-data"),
                a = n.attr("data-playlist"),
                o = (new Date).getTime();
            this.poster = t.find(".ns-panel__section-emp-img"), this.empVisible || (this.empVisible = !0, i.elm.append('<div id="ns-player--' + o + '" class="ns-panel__emp_player"></div>'), i.emp = {
                elm: e.$("#ns-player--" + o),
            ...
            }), this.poster.addClass("ns-panel__section-emp-img--hide"), i.emp.player.poster(this.poster.attr("src")), i.sizeEmp(), i.emp.player.load(a), n.after(i.emp.elm)
        },
        sizeEmp: function() {
        ...
        hideEmp: function() {
            e.$(".ns-panel__section-emp-img").removeClass("ns-panel__section-emp-img--hide"), this.empVisible && (this.elm.find(".ns-panel__emp_player").remove(), this.empVisible = !1)
        },
        show: function(s) {
            this.hide(), this.currentPanel = s;
            // window.alert(s);
            var t = e.$(this.panels.get(s));
            t.addClass("ns-panel__section--show"), this.setHotspotActiveState(s), this.maskElm && (this.showMask(), this.maskElm.height(e.$("#blq-container-outer, #blq-container")[0].clientHeight)), this.empPanels.get(s) !== !1 ? this.loadBump(t) : this.hideEmp()
        },
        hide: function() {
            this.hideEmp(), this.elm.find(".ns-panel__section--show").removeClass("ns-panel__section--show"), this.currentPanel = this.panels.sortKeys()[0], this.hideMask(), this.setHotspotActiveState(0)
        },
        next: function() {
            //console.log('Next');
            var s, t = this.panels.sortKeys();
            t.indexOf(this.currentPanel) === t.length - 1 ? s = this.currentPanel : (s = t[t.indexOf(this.currentPanel) + 1], e.pubsub.emit("ns-panel:show", [s]))
        },
        prev: function() {
            ...
            if (s.indexOf(this.currentPanel) > 0) {
                ...
                e.pubsub.emit("ns-panel:show", [t])
            }
        },
        addNextPrevButtons: function() {
            for (var s = this, t = s.panels.sortKeys(), i = 0; i < s.panels.size; i++) {
                var n = t[i],
                    a = '<a href="#ns-panel__section-' + t[i - 1] + '" class="ns-panel__next-prev ns-panel__prev">',
                    o = '<a href="#ns-panel__section-' + t[i + 1] + '" class="ns-panel__next-prev ns-panel__next">';
                0 === i ? a = '<a href="#" class="ns-panel__next-prev ns-panel__prev ns-panel__next-prev--disabled">' : i === s.panels.size - 1 && (o = '<a href="#" class="ns-panel__next-prev ns-panel__next ns-panel__next-prev--disabled">'), e.$(s.panels.get(n)).append('<div class="ns-panel__section-nav">' + a + '<span class="ns-panel__hide">' + s.vocab.prev + '</span><span class="ns-panel__arrow-left "></span><span class="ns-panel__arrow-left--inside"></span></a><div class="ns-panel__counter"> ' + (i + 1) + " " + s.vocab.pagingDivider + " " + s.panels.size + " </div>" + o + '<span class="ns-panel__hide">' + s.vocab.next + '</span><span class="ns-panel__arrow-right"></span><span class="ns-panel__arrow-right--inside"></span></a></div>')
            }
        },
        showHideClickableGuide: function(e, s) {
            this.viewportIsBigEnoughForClickableGuide(e, s) ? (this.elm.addClass("ns-panel--interactive"), 0 !== this.currentPanel && this.showMask()) : (this.elm.removeClass("ns-panel--interactive"), this.hideMask()), this.sizeEmp()
        },
        ...
        addMask: function(s) {
            ("white" === s || "black" === s) && (e.$("body").append('<div class="ns-panel__mask ns-panel__mask--' + s + '"></div>'), this.maskElm = e.$(".ns-panel__mask"))
        },
        showMask: function() {
            this.maskElm && (this.maskElm.addClass("ns-panel__mask--show"), this.maskElm.height(e.$("body").height()))
        },
        hideMask: function() {
            this.maskElm && this.maskElm.removeClass("ns-panel__mask--show")
        },
        ...
        choosePanelPosition: function(s) {
            ...
            if ("default" === s || "centre_of_interactive" === s)
                ...
                for (t in n.panels._map) i = n.panels.get(t), i.addClass("ns-panel__section--align-right");
            else if ("centre_of_screen" === s && e.browserNotOnThePositionFixedNaughtyList)
                for (t in n.panels._map) i = n.panels.get(t), i.addClass("ns-panel__section--centre_of_screen"), i.css({
        ...
        setHotspotActiveState: function(s) {
            e.$(".ns-panel__hotspot").removeClass("ns-panel__hotspot--active"), e.$(".ns-panel__hotspot--" + s).addClass("ns-panel__hotspot--active")
        },
